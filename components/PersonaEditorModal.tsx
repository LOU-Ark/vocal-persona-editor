...
interface CreatePersonaScreenProps {
  onBack: () => void;
...
export const CreatePersonaScreen: React.FC<CreatePersonaScreenProps> = ({ onBack, onSave }) => {
    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <header className="flex-shrink-0 sticky top-0 z-20 bg-gray-900/95 backdrop-blur-sm">
