...
export const IssueReporter: React.FC<IssueReporterProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center z-[60] p-4" onClick={onClose}>
      <div className="bg-gray-800/90 backdrop-blur-sm border border-gray-700 rounded-lg shadow-2xl w-full max-w-4xl h-[90vh] flex flex-col relative" onClick={(e) => e.stopPropagation()}>
        ...
        <main className="flex-grow p-6 overflow-y-auto grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
          <div className="flex flex-col gap-4 md:border-r md:border-gray-700 md:pr-8">
